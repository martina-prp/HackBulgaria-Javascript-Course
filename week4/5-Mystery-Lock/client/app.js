...
$(document).ready(function() {
  ...
  // Buttons do not exists yet!!!
  // So, attach the click to the document.
  $(document).on("click", ".secret-button", function() {
    var currentButtonId = $(this).data("index");
    var currentButton = $(this);

    $.ajax({
      url: "http://localhost:3000/secret/" + $(this).data("token"),
      type: "GET",
